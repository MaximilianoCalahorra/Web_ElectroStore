...
<html lang="es">
    ...
    <body class="body">
        <!-- Encabezado -->
		<header class="header">
			<h1 class="header__h1"><a href="<?= base_url();?>Iniciar/cargarInicioAdministrador">ElectroStore</a></h1>
		</header>
        <!-- Barra de navegación -->
        <nav class="nav-sitio-web">
            <ul class="nav-sitio-web__ul">
                ...
                <div class="nav-sitio-web__li-container">
                    <li class="nav-sitio-web__li"><i class="fa-solid fa-house-chimney"></i><a href="<?= base_url();?>Iniciar/cargarInicioAdministrador">Inicio</a></li>
                    <li class="nav-sitio-web__li"><i class="fa-solid fa-cart-shopping"></i><a href="<?= base_url();?>AdministrarProducto/cargarProductosAdministrador">Productos</a></li>
                    <li class="nav-sitio-web__li"><i class="fa-solid fa-users"></i><a href="<?= base_url();?>AdministrarCliente/cargarClientesAdministrador">Clientes</a></li>
                    <li class="nav-sitio-web__li"><i class="fa-solid fa-shop"></i><a href="<?= base_url();?>AdministrarSucursal/cargarSucursalesAdministrador">Sucursales</a></li>
