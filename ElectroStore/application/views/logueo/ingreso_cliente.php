...
<html lang="es">
    <head>
        ...
        <title>ElectroStore | Logueo Cliente</title>
    </head>
    <body class="body">
        <!-- Encabezado -->
		<header class="header">
        ...
        <!-- Logueo para los clientes -->
        <main class="main">
            <h2 class="main__h2 titulos">Logueo para clientes</h2>
            <div class="main__div">
                <form class="main__form" action="<?= base_url(); ?>Iniciar/validarCliente" method="POST">                   
            ...
            <h4 class="main__h4 titulos"><?php echo($mensaje_al_cliente);?></h4>
        </main>
    </body>
</html>